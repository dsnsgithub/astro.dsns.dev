		...
		return (
			<div className="bg-viola-100 rounded-lg p-8 m-2 shadow-lg">
				...
				<div className="flex items-center space-x-4">
					...
					<div>
						<h4 className="text-sm w-32 md:w-48 lg:w-32 xl:w-32 2xl:w-48 truncate" title={spotify.song} aria-label={spotify.song}>
							{spotify.song}
						</h4>
						<p className="text-xs w-32 md:w-48 lg:w-32 xl:w-32 2xl:w-48 truncate" title={spotify.artist} aria-label={spotify.artist}>
							by {spotify.artist}
						</p>
						<p className="text-xs w-32 md:w-48 lg:w-32 xl:w-32 2xl:w-48 truncate" title={spotify.album} aria-label={spotify.album}>
							on {spotify.album}
						</p>
					</div>
				</div>
